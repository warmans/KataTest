...
/**
 * 
 * @link http://codekata.pragprog.com/2007/01/kata_two_karate.html
 * 
 * A binary chop (sometimes called the more prosaic binary search) finds the position of value
 * in a sorted array of values. It achieves some efficiency by halving the number of items under
 ...
 * memory performance are not issues (assuming the chop terminates before you get bored and kill it,
...
class BinSearch extends \Kata\Core\KataAbstract {
    ...
    /*
     * You can run this function using php -f [dir]/kata.php BinSearch mySolution
     */
    public function mySolution($haystack, $needle) {
        //do something
    }
